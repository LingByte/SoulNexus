...
type Group struct {
	...
	Creator    auth.User            `json:"creator,omitempty" gorm:"foreignKey:CreatorID"`
...
type GroupInvitation struct {
	...
	Inviter   auth.User       `json:"inviter,omitempty" gorm:"foreignKey:InviterID"`
	InviteeID uint       `json:"inviteeId" gorm:"index"`
	Invitee   auth.User       `json:"invitee,omitempty" gorm:"foreignKey:InviteeID"`
