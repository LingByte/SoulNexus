...
type WorkflowInstance struct {
	...
	TriggerSource  string              `json:"triggerSource" gorm:"size:64;index"`
	ClientMeta     JSONMap               `json:"clientMeta" gorm:"type:json"`
	...
	InputParams    JSONMap               `json:"inputParameters" gorm:"type:json"`
	ExecutionLogs  JSONArray             `json:"executionLogs" gorm:"type:json"`
	LogCount       int                   `json:"logCount" gorm:"default:0"`
