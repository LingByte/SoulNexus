...
type AliyunTTSConfig struct {
	...
	// boundaries). Realtime realtime traffic should stick to server_commit.
...
// QCloudService.SynthesizeStream so it slots into the voicedialog adapter.
