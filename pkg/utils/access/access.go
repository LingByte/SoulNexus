...
var (
	...
	errJWTKeyManagerNil    = errors.New("jwt: key manager is nil")
	errJWTTTLNotPositive   = errors.New("jwt: ttl must be positive")
	errJWTSecretTooShort   = errors.New("jwt: signing secret too short (min 8 bytes)")
	errJWTInvalidPlatform       = errors.New("jwt: invalid platform payload")
	errJWTRefreshSecretTooShort = errors.New("jwt: refresh signing secret too short (min 8 bytes)")
	errTOTPKeyNil               = errors.New("totp: key is nil")
)
...
func ParseAccessToken(tokenString, secret string) (*AccessPayload, error) {
	...
	return &AccessPayload{
		...
		DeviceRecordID: ac.DeviceRecordID,
	}, nil
}
