...
// Query emits a signal and collects the synchronous result (last param is *constants.PersistQueryResult).
func (s *Signals) Query(event string, params ...any) *constants.PersistQueryResult {
	r := &constants.PersistQueryResult{}
