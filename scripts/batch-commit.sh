...
commit_msg "refactor(internal): update tenant and auth handlers" internal/handlers/tenants.go internal/handlers/tenant_users.go internal/handlers/tenant_users_me.go internal/handlers/tenant_organization.go internal/handlers/tenant_webhooks.go internal/handlers/tenant_llm_stream.go
...
commit_msg "feat(web): update profile and misc console pages" web/src/pages/Profile.tsx web/src/pages/profile web/src/components/profile web/src/pages/ComponentsDemo.tsx web/src/pages/CredentialManager.tsx web/src/pages/DeviceManagement.tsx web/src/pages/DeviceDetail.tsx web/src/pages/pet-market web/src/pages/platform
