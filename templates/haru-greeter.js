/**
 * SoulNexus — Haru 桌宠（haru-greeter.js）
 * Cubism 4 · pixi-live2d-display 示例 Haru（招呼）
...
(function () {
    ...
    var CSS_ID = 'lingecho-cubism-haru-greeter-css';
    var STORAGE_KEY = 'cubism-pet-haru-greeter-v1';

    var PET = {
        name: 'Haru',
        modelUrl: 'https://cdn.lingecho.com/live2d/haru/haru_greeter_t03.model3.json',
        idleMotion: 'Idle',
        tapMotion: 'Tap',
    };
    ...
    Live2dPet.prototype.ask = function (userText) {
        ...
        var prefix =
            ...
            '桌宠】你是「' +
            self.name +
            '」。回复 1～2 句中文。可选标签：[motion:Tap]、[expression:f01]。';
