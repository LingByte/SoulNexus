/**
 * SoulNexus — Hiyori 桌宠（hiyori.js）
 * Cubism 4 · 官方样本 Hiyori
...
(function () {
    ...
    var CSS_ID = 'lingecho-cubism-hiyori-css';
    var STORAGE_KEY = 'cubism-pet-hiyori-v1';

    var PET = {
        name: 'Hiyori',
        modelUrl: 'https://cdn.lingecho.com/live2d/hiyori/Hiyori.model3.json',
        idleMotion: 'Idle',
        tapMotion: 'TapBody',
    };
