...
(function () {
    ...
    var CSS_ID = 'lingecho-cubism-mark-css';
    var STORAGE_KEY = 'cubism-pet-mark-v1';

    var PET = {
        name: 'Mark',
        modelUrl: 'https://cdn.lingecho.com/live2d/mark/Mark.model3.json',
        idleMotion: 'Idle',
        tapMotion: 'Idle',
    };
    ...
    Live2dPet.prototype.ask = function (userText) {
        ...
        var prefix =
            ...
            '桌宠】你是「' +
            self.name +
            '」。回复 1～2 句中文。可选标签：[motion:Idle]、[expression:f01]。';
