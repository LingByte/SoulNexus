/**
 * SoulNexus — Natori 桌宠（natori.js）
 * Cubism 4 · 官方样本 Natori
...
(function () {
    ...
    var CSS_ID = 'lingecho-cubism-natori-css';
    var STORAGE_KEY = 'cubism-pet-natori-v1';

    var PET = {
        name: 'Natori',
        modelUrl: 'https://cdn.lingecho.com/live2d/natori/Natori.model3.json',
        idleMotion: 'Idle',
        tapMotion: 'TapBody',
    };
