...
(function () {
    ...
    var CSS_ID = 'lingecho-cubism-rice-css';
    var STORAGE_KEY = 'cubism-pet-rice-v1';

    var PET = {
        name: 'Rice',
        modelUrl: 'https://cdn.lingecho.com/live2d/rice/Rice.model3.json',
        idleMotion: 'Idle',
        tapMotion: 'TapBody',
    };
