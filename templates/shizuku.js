/**
 * SoulNexus — Shizuku 桌宠（shizuku.js）
 * Cubism 2 · pixi-live2d-display 示例 Shizuku
...
(function () {
    ...
    var CSS_ID = 'lingecho-cubism-shizuku-css';
    var STORAGE_KEY = 'cubism-pet-shizuku-v1';

    var PET = {
        name: 'Shizuku',
        modelUrl: 'https://cdn.lingecho.com/live2d/shizuku/shizuku.model.json',
        idleMotion: 'idle',
        tapMotion: 'tap_body',
    };
    ...
    var BUILTIN_LIVE2D_SDK = 'https://cdn.lingecho.com/live2d/sdk/cubism2.min.js';
    ...
    function ensureLive2dRuntime() {
        ...
        return loadScript(LIVE2D_LEGACY_CDN)
            .then(function () {
    ...
    Live2dPet.prototype.ask = function (userText) {
        ...
        var prefix =
            ...
            '桌宠】你是「' +
            self.name +
            '」。回复 1～2 句中文。可选标签：[motion:tap_body]、[expression:f01]。';
