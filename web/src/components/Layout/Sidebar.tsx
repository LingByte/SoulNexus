...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: 'nav.pixelGif', href: '/pixel/gif', icon: Film, tenantAllUsers: true },
      { labelKey: 'nav.pixelAdjust', href: '/pixel/adjust', icon: LayoutGrid, tenantAllUsers: true },
      { labelKey: 'nav.pixelProcess', href: '/pixel/process', icon: SlidersHorizontal, tenantAllUsers: true },
      { labelKey: 'nav.pixelFine', href: '/pixel/fine', icon: Paintbrush, tenantAllUsers: true },
      { labelKey: 'nav.pixelPixelate', href: '/pixel/pixelate', icon: Aperture, tenantAllUsers: true },
      { labelKey: 'nav.pixelExpandShrink', href: '/pixel/expand-shrink', icon: Maximize2, tenantAllUsers: true },
      { labelKey: 'nav.pixelGeminiWatermark', href: '/pixel/gemini-watermark', icon: Eraser, tenantAllUsers: true },
      { labelKey: 'nav.pixelRpgmaker', href: '/pixel/rpgmaker', icon: Sparkles, tenantAllUsers: true },
      { labelKey: 'nav.pixelPro', href: '/pixel/pro', icon: Wrench, tenantAllUsers: true },
      { labelKey: 'nav.pixelControlTest', href: '/pixel/control-test', icon: Gamepad2, tenantAllUsers: true },
      { labelKey: 'nav.pixelMapStitch', href: '/pixel/map-stitch', icon: Map, tenantAllUsers: true },
      { labelKey: 'nav.pixelInfiniteMap', href: '/pixel/infinite-map', icon: Globe2, tenantAllUsers: true },
