...
<script src="${import.meta.env.VITE_API_BASE_URL || 'http://localhost:7072/api'}/agents/lingecho/client/${jsSourceId === '' ? '未选择智能体' : jsSourceId}/loader.js"></script>
    `,
    flutter: `
// pubspec.yaml 依赖
dependencies:
...
class _VoiceAssistantPageState extends State<VoiceAssistantPage> {
  ...
  void _initWebView() {
    _controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('${import.meta.env.VITE_API_BASE_URL || 'http://localhost:7072'}/api/agents/lingecho/client/${jsSourceId === '' ? '未选择智能体' : jsSourceId}/loader.js'));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('语音智能体')),
