...
import {
  ...
  KnowledgeBaseNodeConfigBody,
} from '../node-configs/InlineNodeConfigs'
 ...
 * 知识库节点配置
 */
const KnowledgeBaseNodeConfig: React.FC<{
  node: WorkflowNode
  onConfigChange: (config: any) => void
}> = ({ node, onConfigChange }) => (
  <KnowledgeBaseNodeConfigBody node={node} onConfigChange={onConfigChange} />
)
...
const AIChatNodeConfig: React.FC<{
  ...
  <AIChatNodeConfigBody node={node} onConfigChange={onConfigChange} />
)
