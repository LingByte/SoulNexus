...
export const auth: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'profile.accountBindingsTitle': '账号绑定与邮箱验证',
  ...
  en: {
    ...
    'profile.tabs.settings': 'Account & preferences',
    ...
    'profile.accountBindingsTitle': 'Linked accounts & email verification',
  ...
  ja: {
    ...
    'profile.tabs.settings': 'アカウントと設定',
    ...
    'profile.accountBindingsTitle': 'アカウント連携とメール確認',
