      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="flex-1">
            <ArcoInput size="large" className="!h-10 !text-base" placeholder="搜索插件..."
              value={searchKeyword}
    ...
    <div className="space-y-4 max-h-[70vh] overflow-y-auto">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" value={formData.displayName}
        ...
        <div>
          ...
          <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" value={formData.version}
      ...
      <div>
        ...
        <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" value={formData.tags}
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" value={formData.author}
        ...
        <div>
          ...
          <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" value={formData.homepage}
        ...
        <div>
          ...
          <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" value={formData.repository}
            ...
            {(formData.inputSchema?.parameters || []).map((param: any, index: number) => (
              <div key={index} className="p-3 border border-gray-200 rounded-lg">
                <div className="grid grid-cols-2 gap-2 mb-2">
                  <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" placeholder="参数名"
                    value={param.name}
                    onChange={(e) => {
                ...
                <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" placeholder="描述"
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" value={formData.name}
