    ...
    <div className="space-y-4 max-h-[70vh] overflow-y-auto">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <ArcoInput size="large" className="!h-10 !text-base" value={formData.version}
            ...
            {(formData.inputSchema?.parameters || []).map((param: any, index: number) => (
              <div key={index} className="p-3 border border-gray-200 rounded-lg">
                <div className="grid grid-cols-2 gap-2 mb-2">
                  <ArcoInput size="large" className="!h-10 !text-base" placeholder="参数名"
                    value={param.name}
                    onChange={(e) => {
                ...
                <ArcoInput size="large" className="!h-10 !text-base" placeholder="描述"
