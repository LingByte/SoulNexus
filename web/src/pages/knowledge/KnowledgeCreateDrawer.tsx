      ...
      >
        ...
        <div className="flex-1 space-y-4 overflow-y-auto p-4">
          ...
          <div>
            ...
            <ArcoInput size="large" className="!h-10 !text-base" value={formNs} onChange={(e) => setFormNs(e.target.value)} />
          </div>
          <div>
            <label className="mb-1 block text-xs font-medium text-muted-foreground">{t('knowledge.fieldName')}</label>
            <ArcoInput size="large" className="!h-10 !text-base" className="!h-10 !text-base" value={formName} onChange={(e) => setFormName(e.target.value)} />
          </div>
          <div>
