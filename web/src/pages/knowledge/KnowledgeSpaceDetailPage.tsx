        ...
        {tab === 'docs' && (
          <Card className="overflow-hidden border-border/80">
            <div className="flex flex-wrap gap-2 border-b border-border p-3">
              <ArcoInput size="large" value={docQInput}
          ...
          <Card className="space-y-4 border-border/80 p-4 md:p-6">
            ...
            <div className="flex flex-wrap gap-4">
              <div>
                ...
                <ArcoInput size="large" type="number" value={String(recallTopK)} onChange={(e) => setRecallTopK(parseInt(e.target.value, 10) || 5)} className="w-24" />
              </div>
              <div>
                <label className="mb-1 block text-xs text-muted-foreground">{t('knowledge.minScore')}</label>
                <ArcoInput size="large" type="number" step={0.05} value={String(recallMin)} onChange={(e) => setRecallMin(parseFloat(e.target.value) || 0)} className="w-24" />
              </div>
            </div>
